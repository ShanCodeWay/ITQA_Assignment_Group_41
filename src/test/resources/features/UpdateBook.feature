Feature: Admin Update Book
  ...
  Scenario: Admin tries to update a book with mismatched ID
    ...
    Then Admin should receive a failed response with status code 404 and error message "Book id is not matched"
  ...
  Scenario: Admin tries to update a book with missing title
    ...
    Then Admin should receive a failed response with status code 400 and error message "Title cannot be null"
  ...
  Scenario: Admin tries to update a book with missing author
    ...
    Then Admin should receive a failed response with status code 400 and error message "Author cannot be null"
  ...
  Scenario: Admin tries to update a book with duplicate title
    ...
    Then Admin should receive a failed response with status code 400 and error message "Book Title Already Exists"
  ...
  Scenario: Admin tries to update a book with missing title and missing author
    ...
    Then Admin should receive a failed response with status code 400 and error message "Mandatory parameters should not be null"
  ...
  Scenario: User tries to update a book
    ...
    Then User should receive a failed response with status code 403 and error message "User not permitted"
